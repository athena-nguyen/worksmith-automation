...
if __name__ == "__main__":
    try:
        ...
        print()
        print("=" * 50)
        print("  ERROR: Missing column in spreadsheet.")
        print()
        print(f"  Column not found: {e}")
        print()
        print("  Make sure worksmith.csv has these columns:")
        print("  company, ticket_id, item, service_type,")
        print("  quantity, price_per_unit, notes")
        print()
        print("  If you edited the file in Excel, try saving")
        print('  it as CSV UTF-8 (not just "CSV").')
        print("=" * 50)
